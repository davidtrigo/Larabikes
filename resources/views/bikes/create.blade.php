...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
     <head>
        ...
        <title>{{config('app.name')}} - NUEVA MOTO </title>
   ...
   <div class="form-group  row">
    ...
    <div class="form-group  row">
 	...
 	<div class="form-group  row">
       	...
       	<input name="precio" type="number" maxlength="11" class="up form-control col-sm-4" id="inputPrecio" placeholder="precio"
   			 	 required="required" min="0" value="{{old('precio')}}">
	</div>	
	<div class="form-group  row">
       	...
       	<input name="kms" type="number" class="up form-control col-sm-4" id="inputkms" placeholder="kms"
   			 	 required="required" value="{{old('kms')}}">
	</div>
	...
	<div class="form-group  row">
       ...
       <button type="submit" class="btn btn-secondary">Borrar</button>
    	...
    	<div class="text-center my-3">
    		...
    		<a href ="{{route('bikes.index')}}" class="btn btn-primary">Listado</a>
    	</div>
